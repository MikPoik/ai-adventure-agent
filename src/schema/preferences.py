...
class Preferences(BaseModel):
    ...
    seed: int = Field(
        ...
        description=
        "Used to pin a consistent style for game for music and image generation.",
    )
    ...
    narration_model: str = Field("elevenlabs",
                                 description="Model used for audio narration")
    image_generation_lora: str = Field(
        default="https://civitai.com/api/download/models/123593",
        description=
        "Preferred LoRA to use for image generation. This MUST be a known SDXL-based LoRA."
